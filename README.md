...
1. Explain the difference between `RDBMS` and `SQL`.
	...
	RDBMS are a type of database and SQL is a language used to manipulate databases.

1. Why do tables need a `primary key`?

	Because we need a unique id that can differentiate between entries with the same names.
...
1. What do we need in order to have a _many to many_ relationship between two tables.
	...
	Create a third table between the two.
